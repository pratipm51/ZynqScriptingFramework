...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set enet0_phy_clk [ create_bd_port -dir O -type clk enet0_phy_clk ]
...
1#UART 1#I2C 0#I2C 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO} \
...
\
    ...
    CONFIG.PCW_TTC1_CLK0_PERIPHERAL_DIVISOR0 {10} \
